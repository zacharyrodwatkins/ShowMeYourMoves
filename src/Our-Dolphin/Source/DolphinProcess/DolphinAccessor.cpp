...
std::string DolphinAccessor::statusString(DolphinAccessor::DolphinStatus code){

  switch (code)
  {
  case DolphinStatus::hooked:
    return std::string("hooked");
  
  case DolphinStatus::noEmu:
    return std::string("No Emulator");

  case DolphinStatus::notRunning:
    return std::string("Not Running");

  case DolphinStatus::unHooked:
    return std::string("Unhooked");
